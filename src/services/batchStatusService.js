...
import { fetchOverallStatusMock } from '../data/mockBatchData.js';
...
export const fetchOverallStatus = async () => {
  try {
    // Use mock data in development to avoid needing separate backend server
    if (import.meta.env.DEV) {
      console.log('Using mock data for development');
      return await fetchOverallStatusMock();
    }
